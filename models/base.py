...
from transformers import get_linear_schedule_with_warmup, BertTokenizer, BertModel, BertTokenizerFast, \
...
class MedicalNerModel(pl.LightningModule):
    ...
    def __init__(self, args: argparse.Namespace):
        ...
        self.model = AutoModelForTokenClassification.from_pretrained("bert-base-chinese", cache_dir=cache_dir,
                                                                     local_files_only=True,
                                                                     num_labels=5)
